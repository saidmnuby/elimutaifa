            ...
            <div class="grid-layout">
                ...
                <section class="intro-card">
                    <div class="badge-fast">
                        <i class="fa-solid fa-bolt"></i> FTNA Examination Results
                    </div>
                    <h2 >MATOKEO YA NECTA</h2>
                    <h3 class="intro-title">Form Two <br> (Kidato cha Pili)</h3>
                    <p class="intro-desc">Pata matokeo yako ya mtihani wa Kidato cha Pili (FTNA) kwa haraka na kwa urahisi. Ingiza namba yako ya mtihani kisha uchague mwaka uliofanya mtihani.</p>
                </section>
