    ...
    function showConsent() {
        ...
        banner.innerHTML = `
            <div class="consent-copy">
                ...
                <p>By continuing to use ElimuTaifaTaifaTaifaTaifaTaifa, you acknowledge our <a href="${getSitePath('get-results-faster/privacy')}">Privacy Policy</a> and <a href="${getSitePath('get-results-faster/privacy/#terms')}">Terms of Service</a>. We use essential session cookies and temporary storage to operate and improve the service.</p>
            </div>
