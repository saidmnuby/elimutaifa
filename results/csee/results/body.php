...
<head>
    ...
    <title>Matokeo ya CSEE | ElimuTaifa</title>
...
<body class="education-page level-results" data-exam="csee">
    ...
    <div class="main-wrapper">
        ...
        <div data-et-placement-slot="top" data-et-placement-page="csee-results" hidden></div>
        <main class="content-container">
            <div class="grid-layout">
                ...
                <section class="intro-card">
                    ...
                    <h1 class="intro-title">Matokeo ya Form Four <?php echo htmlspecialchars($examYear);?> (CSEE)</h1>
                    <section class="seo-content">
                        <p>Angalia matokeo ya mtihani wa kidato cha nne
                            (CSEE) mwaka <?php echo htmlspecialchars($examYear);?> kwa
        ...
        </main><div data-et-placement-slot="bottom" data-et-placement-page="csee-results" hidden></div>
