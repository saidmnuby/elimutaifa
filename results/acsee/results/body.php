...
<body class="education-page level-results" data-exam="acsee">
    ...
    <div class="main-wrapper">
        ...
        <div data-et-placement-slot="top" data-et-placement-page="acsee-results" hidden></div>
        <main class="content-container">
            <div class="grid-layout">
                ...
                <section class="intro-card">
                    ...
                    <h1 class="intro-title">Matokeo ya Form Six <?php echo htmlspecialchars($examYear);?> (ACSEE)</h1>
                    <section class="seo-content">
                        <p>Angalia matokeo ya mtihani wa kidato cha sita
                            (ACSEE) mwaka <?php echo htmlspecialchars($examYear);?> kwa
        ...
        </main><div data-et-placement-slot="bottom" data-et-placement-page="acsee-results" hidden></div>
