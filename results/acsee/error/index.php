...
<head>
    ...
    <link
    rel="canonical"
    href="https://saidmnuby.github.io/elimutaifa/results/acsee/">
    ...
    content="https://saidmnuby.github.io/elimutaifa/error/acsee/">
...
<body class="education-page level-error" data-exam="acsee">
 ...
 class="commit-button" onclick="window.location.href='../'">RUDI ▶</button>
    ...
    <div class="main-wrapper">
        ...
        <div data-et-placement-slot="top" data-et-placement-page="acsee-error" hidden></div>
    ...
    <button type="submit" class="btn btn-green">
        ...
        </main><div data-et-placement-slot="bottom" data-et-placement-page="acsee-error" hidden></div>
