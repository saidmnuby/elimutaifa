...
<body class="education-page level-results" data-exam="sfna">
    ...
    <div class="main-wrapper">
        ...
        <div data-et-placement-slot="top" data-et-placement-page="sfna-results" hidden></div>
        <main class="content-container">
            <div class="grid-layout">
                ...
                <section class="intro-card">
                    ...
                    <h1 class="intro-title">Matokeo ya Darasa la Nne <?php echo htmlspecialchars($examYear);?> (SFNA)</h1>
                    <section class="seo-content">
                        <p>Angalia matokeo ya upimaji wa Darasa la Nne wa elimu ya msingi
                            (SFNA) kwa mwaka <?php echo htmlspecialchars($examYear);?> kwa
        ...
        </main><div data-et-placement-slot="bottom" data-et-placement-page="sfna-results" hidden></div>
