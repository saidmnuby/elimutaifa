...
<head>
    ...
    <meta
    name="description"
    content="Angalia matokeo ya Form Two (FTNA) ya NECTA kwa mwaka 2026. Tafuta matokeo kwa namba ya mtihani.">

    <link
    rel="canonical"
    href="https://saidmnuby.github.io/elimutaifa/results/ftna/">

    <meta property="og:title"
    content="Matokeo ya Form Two 2026 - NECTA">

    <meta property="og:description"
    content="Angalia matokeo ya Form Two  mwaka 2026 na Elimutaifa.">

    <meta property="og:type" content="website">
    
    <meta property="og:url"
    content="https://saidmnuby.github.io/elimutaifa/results/ftna/">
...
<body class="education-page level-error" data-exam="ftna">
    ...
    <div class="main-wrapper">
        ...
        <div data-et-placement-slot="top" data-et-placement-page="ftna-error" hidden></div>
        <main class="content-container">
            <div class="grid-layout">
                ...
                <section class="intro-card">
                    ...
                    <h1 class="intro-title">Matokeo ya Form Two 2026 (FTNA)</h1>
                    <section class="seo-content">
                        <p>Angalia matokeo ya mtihani wa kidato cha pili
                            (FTNA) kwa mwaka 2026 kwa
    ...
    <button type="submit" class="btn btn-green">
        ...
        </main><div data-et-placement-slot="bottom" data-et-placement-page="ftna-error" hidden></div>
