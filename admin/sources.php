...
$levels = [
    ...
    ['Form Five / Vyuo vya kati', '../selection/form-five/', 'School browsing (stage one)', ['selform.tamisemi.go.tz']],
];
...
<section class="admin-card" style="margin-bottom:18px"><h2>Form One selection</h2><p>Simamia intake year, PSLE year, selection round, source na default cycle.</p><a class="admin-button" href="sources.php?section=form-one">Simamia cycles</a></section>
<section class="admin-card" style="margin-bottom:18px"><h2>Form Five / Vyuo vya kati</h2><p>Simamia CSEE year, selection round, source na default cycle.</p><a class="admin-button" href="sources.php?section=form-five">Simamia cycles</a></section>
