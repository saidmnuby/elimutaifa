...
if($id<=0 || !in_array($status,['open','resolved'],true)){et_flash('error','Event update si sahihi.');et_redirect('./');}
...
et_flash('success',$status==='resolved'?'Event imewekwa resolved.':'Event imefunguliwa tena.');
