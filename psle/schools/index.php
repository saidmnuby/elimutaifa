        ...
        <main class="content-container">
            ...
            <div class="grid-layout-results">
                ...
                <section class="intro-card">
                    ...
                    <h2 >MATOKEO YA NECTA -Darasa la Saba (PSLE) 2026</h2>
                    <h3 class="intro-title">ILALA, DAR ES SALAAM</h3>
                </section>
                ...
                <div class="right-column-results">
                    <div class="card">
                        <div class="schoolCard">
                            <?php // foreach:($shools as $chool)?>
                            <div class="oneSchool">
                                ASSUMPTION PRIMARY SCHOOL - PS1109044
                            </div>
